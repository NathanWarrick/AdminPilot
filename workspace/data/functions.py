...
def click(path):
    img = pyautogui.locateCenterOnScreen(path, confidence=0.98)
    click_x = img[0]
    click_y = img[1]
    ...
    if (
        str(
            pyautogui.locateOnScreen(
                r"workspace/assets/general/Print Job Notification.png"
            )
        )
        != "None"
    ):
        ...
        while (
            str(
                pyautogui.locateOnScreen(
                    r"workspace/assets/general/Print Job Notification zAdmininstration.png"
                )
            )
            == "None"
        ):
...
def print_audit_trail():
    ...
    sleep(10)
    if (
        str(pyautogui.locateOnScreen(r"workspace/assets/general/Filename_Dark.png"))
        != "None"
    ):
        click(r"workspace/assets/general/Filename_Dark.png")
    else:
        if (
            str(pyautogui.locateOnScreen(r"workspace/assets/general/Filename2.png"))
            != "None"
        ):
...
def BPAY():
    ...
    if (
        str(
            pyautogui.locateOnScreen(
                r"workspace/assets/financial/Errors/There are no records to generate the batch with.png"
            )
        )
        != "None"
    ):
