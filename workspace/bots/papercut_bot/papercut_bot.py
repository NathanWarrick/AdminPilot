...
class Browser: # Selenium Browser Configuration
    ...
    def papercut_deposit(self, name: str, amount: str, paymentmethod: str, comment: str):
        ...
        self.add_input(by=By.NAME, value='paymentMethod', text=paymentmethod) # EFT, Cash or Other
...
def deposit(ref, amount, method, comment):   
    ...
    try:
        ...
        browser.open_page('https://papercut.horsham-college.vic.edu.au/webcashier')
        browser.login_papercut(secret.papercut_username, secret.papercut_password)
    browser.open_page('https://papercut.horsham-college.vic.edu.au/app?service=page/WebCashierDeposit')
